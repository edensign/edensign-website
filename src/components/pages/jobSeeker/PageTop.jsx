...
const PageTop = ({ filterOpen, setFilterOpen }) => {
    ...
    const handleClick = () => {
        ...
        box.style.right = filterOpen ? "0" : "27%";
...
{/* <div style={{ border: "1px solid black", height: "100px", width: "80%" }}>
    <canvas id="halfCircleCanvas" width="200" height="100" style={{ float: "right", transform: "scaleY(-1)" }}></canvas>
</div> */}
