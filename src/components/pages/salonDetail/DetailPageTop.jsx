...
const DetailPageTop = (props) => {
    ...
    return (
        <Box sx={{
            ...
            <Box className='big-sliding' style={{
                position: "absolute", width: "100%", height: "100%", opacity: "0", transition: "all 1s ease-in", filter: "blur(10px)"
            }}>
                <img src={Salon1} style={{ aspectRatio: "1300/715", width: "100%" }} />
            </Box>

            <Box className='big-sliding' style={{
                position: "absolute", width: "100%", height: "100%", opacity: "0", transition: "all 1s ease-in", filter: "blur(10px)"
            }}>
                <img src={Salon2} style={{ aspectRatio: "1300/715", width: "100%" }} />
            </Box>
            <Box className='big-sliding' style={{
                position: "absolute", width: "100%", height: "100%", opacity: "0", transition: "all 1s ease-in", filter: "blur(10px)"
            }}>
                <img src={Salon3} style={{ aspectRatio: "1300/715", width: "100%" }} />
            </Box>
