...
const FilterMenu = ({
    ...
    // const [unisexGender, setUnisexGender] = useState('');
    ...
    const handleCategoryClick = (event, value) => {
        if (value === true) {
            ...
            setSelectedCategory(selectedCategory.filter(category => category !== event.target.parentElement.nextSibling.innerText));
        }
    };
    ...
    const handleFilterChange = () => {
        ...
        onFilter(selectedGender, selectedSkill, selectedCategory);
    ...
    return (
        <Box id="filter-box" sx={{
            width: location.pathname === '/salons' ? '21%' : "27%", fontFamily: "Inter, sans-serif", backgroundColor: "#ffffff",
            display: "flex", flexDirection: "column", borderRadius: "14px", opacity: "0", transform: "translateX(100%)",
            transitionDelay: "300ms", transition: "all .5s cubic-bezier(0.77, 0, 0.175, 1)", position: "fixed", color: "#000000",
            top: location.pathname === '/salons' ? '32%' : "21%", right: "0", zIndex: "10", boxShadow: "0 0 9.8px 0.2px rgba(0, 0, 0, 0.14)"
        }}
        >
            ...
            {showSkills && <div>
                ...
                <Box width="100%" display="grid" gap="4px" gridTemplateColumns="repeat(2, minmax(0, 1fr))" justifyItems="start"
                ...
                >
                    <FormControlLabel
                        ...
                        sx={{
                            margin: "0",
                            '& .MuiTypography-root': {
                                fontSize: "12px", fontWeight: "550", letterSpacing: "0.05em", textTransform: "capitalize"
                            }
                        }}
                        control={
                            <Checkbox
                                ...
                                color="default"
                                size="small"
                                onChange={(event, value) => handleSkillClick(event, value)}
                            />
                        } />
                    <FormControlLabel
            ...
            {showCategory && <div>
                ...
                <Box width="75%" display="flex" justifyContent="space-between" padding="4px 10px 2px 10px">
                    <FormControlLabel label="Featured"
                        sx={{
                            margin: "0",
                            '& .MuiTypography-root': {
                                fontSize: "12px", fontWeight: "550", letterSpacing: "0.05em", textTransform: "capitalize"
                        ...
                        control={
                            <Checkbox {...checkboxLabel} color="default" size="small"
                                onChange={(event, value) => handleCategoryClick(event, value)}
                            />
                        } />
                    <FormControlLabel label="Franchise"
                        sx={{
                            margin: "0",
                            '& .MuiTypography-root': {
                                fontSize: "12px", fontWeight: "550", letterSpacing: "0.05em", textTransform: "capitalize"
            ...
            {showGender && <div style={{ marginBottom: location.pathname === '/salons' ? "15px" : null }}>
                ...
                <Divider sx={{ width: "88%", margin: "auto" }} />
                <Box width={location.pathname === '/job-seeker' ? "64%" : "auto"}
                    display="flex" justifyContent="space-around" padding="12px 10px"
                >
                    <Chip sx={{
                        fontSize: "12px", height: "20px", fontWeight: "300"
                    }}
                        label="Male"
                        variant="outlined"
                        size="small"
                        onClick={handleGenderClick}
                        onDelete={handleGenderDelete}
                    />
                    <Chip sx={{
                        fontSize: "12px", height: "20px", fontWeight: "300"
                    }}
            ...
            <div style={{ display: "flex", alignItems: "center", padding: "2px 26px" }}>
                <Button
                    ...
                    type="submit"
                    variant="contained"
                    disabled={selectedSkill.length == 0 && selectedCategory == '' && selectedGender == ''}
