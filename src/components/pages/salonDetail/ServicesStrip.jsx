...
const SERVICE_ICONS = {
  skincare: (
    <svg xmlns='http://www.w3.org/2000/svg' height="36" width="36" viewBox='0 0 44 44' fill="none" style={{ transition: 'all 0.3s ease' }}>
      <g clipPath='url(#clip0)' fill="var(--es-emerald)">
  ...
  waxing: (
    <svg xmlns='http://www.w3.org/2000/svg' height="36" width="36" viewBox='0 0 44 44' fill="none">
      <rect x="6" y="10" width="32" height="24" rx="4" stroke="var(--es-emerald)" strokeWidth="2.5" fill="none" />
      <path d="M12 22h20M12 17h8M12 27h14" stroke="var(--es-emerald)" strokeWidth="2" strokeLinecap="round" />
    </svg>
  ),
  threading: (
    <svg xmlns='http://www.w3.org/2000/svg' height="36" width="36" viewBox='0 0 44 44' fill="none">
      <path d="M8 36 Q16 20 22 14 Q28 8 36 8" stroke="var(--es-emerald)" strokeWidth="2.5" fill="none" strokeLinecap="round" />
      <path d="M8 28 Q18 22 24 16 Q30 10 38 8" stroke="var(--es-emerald)" strokeWidth="2" fill="none" strokeLinecap="round" opacity="0.5" />
    </svg>
  ),
  facial: (
    <svg xmlns='http://www.w3.org/2000/svg' height="36" width="36" viewBox='0 0 44 44' fill="none">
      <circle cx="22" cy="18" r="12" stroke="var(--es-emerald)" strokeWidth="2.5" fill="none" />
      <path d="M16 22c1.5 3 10.5 3 12 0" stroke="var(--es-emerald)" strokeWidth="2" strokeLinecap="round" fill="none" />
      <circle cx="17" cy="17" r="2" fill="var(--es-emerald)" />
      <circle cx="27" cy="17" r="2" fill="var(--es-emerald)" />
      <path d="M14 38c0-4.4 3.6-8 8-8s8 3.6 8 8" stroke="var(--es-emerald)" strokeWidth="2" fill="none" />
    </svg>
  ),
  spa: (
    <svg xmlns='http://www.w3.org/2000/svg' height="36" width="36" viewBox='0 0 44 44' fill="none">
      <path d="M22 8C14 14 8 20 8 28c0 6 6 10 14 10s14-4 14-10c0-8-6-14-14-20z" stroke="var(--es-emerald)" strokeWidth="2.5" fill="none" strokeLinecap="round" />
      <path d="M22 28c-4-4-6-8-4-12" stroke="var(--es-emerald)" strokeWidth="2" strokeLinecap="round" fill="none" opacity="0.6" />
    </svg>
  ),
  beard: (
    <svg xmlns='http://www.w3.org/2000/svg' height="36" width="36" viewBox='0 0 44 44' fill="none">
      <circle cx="22" cy="15" r="9" stroke="var(--es-emerald)" strokeWidth="2.5" fill="none" />
      <path d="M13 24c-3 4-4 10 9 12s12-8 9-12" stroke="var(--es-emerald)" strokeWidth="2.5" strokeLinecap="round" fill="none" />
      <path d="M22 27v9" stroke="var(--es-emerald)" strokeWidth="2" strokeLinecap="round" />
    </svg>
  ),
  default: (
    <svg xmlns='http://www.w3.org/2000/svg' height="36" width="36" viewBox='0 0 44 44' fill="none">
      <path d="M22 4C12.1 4 4 12.1 4 22s8.1 18 18 18 18-8.1 18-18S31.9 4 22 4zm0 34C13.2 38 6 30.8 6 22S13.2 6 22 6s16 7.2 16 16-7.2 16-16 16z" fill="var(--es-emerald)" />
      <path d="M22 12c-5.5 0-10 4.5-10 10s4.5 10 10 10 10-4.5 10-10-4.5-10-10-10zm0 18c-4.4 0-8-3.6-8-8s3.6-8 8-8 8 3.6 8 8-3.6 8-8 8z" fill="var(--es-emerald)" opacity="0.5" />
    </svg>
  ),
};
