    ...
    return (
        <Box borderRadius="4px" width="60vw" height={isTab ? "4vh" : "auto"} position="relative" sx={{
            ...
            <Button onClick={handleSearch} type="submit" variant="contained" color='success' sx={{
                width: "18%", position: "absolute", right: isTab ? "1%" : "0", top: "0", fontSize: "18px", letterSpacing: "0.01em", lineHeight: "2em", fontWeight: "500", padding: "13px", textTransform: "capitalize"
