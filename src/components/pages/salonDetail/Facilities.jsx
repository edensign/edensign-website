...
const Facilities = () => {
    return (
        <Box display="flex" justifyContent="space-around" alignItems="center" sx={{ width: "100%", position: "relative" }}>
            <Box display="flex" flexDirection="column" textAlign="right" width="30%">
                <nav aria-label="services provided by this website">
                    <List sx={{ display: "flex", flexDirection: "column", padding: "8% 0" }}>
                        ...
                        <span style={{ paddingLeft: "35px", fontWeight: "300", fontSize: "12px", lineHeight: "22px", letterSpacing: "0.015em" }}>
            ...
            <Box sx={{ maxWidth: "50%", position: "relative", margin: "0 100px" }}>
            ...
            <Box display="flex" flexDirection="column" width="30%">
                <nav aria-label="services provided by this website">
                    <List sx={{ display: "flex", flexDirection: "column", padding: "8% 0" }}>
                        <ListItemText primary="free shipping" primaryTypographyProps={{ fontWeight: "400", fontSize: "20px", lineHeight: "28px", letterSpacing: "0.14em", textTransform: "uppercase" }} />
                        <span style={{ fontWeight: "300", fontSize: "12px", lineHeight: "22px", letterSpacing: "0.015em" }}>
                            For county now sister engage had season better had waited. Occasional mrs interested.
                        </span>
