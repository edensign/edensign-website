    ...
    return (
        ...
        >
            ...
            >
                ...
                {error && (
                    <Alert severity="error" sx={{ marginBottom: "18px", borderRadius: "8px" }}>
                        {error}
                    </Alert>
                )}

                {success && (
                    <Alert severity="success" sx={{ marginBottom: "18px", borderRadius: "8px" }}>
                        {success}
                    </Alert>
                )}
                ...
                <form onSubmit={formik.handleSubmit}>
                        ...
                        InputProps={{
                            startAdornment: (
                                <InputAdornment position="start">
                                    <PersonIcon sx={{ color: "#888", fontSize: "20px" }} />
                                </InputAdornment>
                            ),
                        }}
                        sx={inputStyles}
                    ...
                    <TextField
                        ...
                        InputProps={{
                            startAdornment: (
                                <InputAdornment position="start">
                                    <PhoneIcon sx={{ color: "#888", fontSize: "20px" }} />
                                </InputAdornment>
                            ),
                        }}
                        sx={inputStyles}
                    ...
                    <TextField
                        ...
                        InputProps={{
                            startAdornment: (
                                <InputAdornment position="start">
                                    <EmailIcon sx={{ color: "#888", fontSize: "20px" }} />
                                </InputAdornment>
                            ),
                        }}
                        sx={inputStyles}
                    ...
                    <TextField
                        ...
                        InputProps={{
                            startAdornment: (
                                <InputAdornment position="start">
                                    <LockIcon sx={{ color: "#888", fontSize: "20px" }} />
                                </InputAdornment>
                            ),
                            endAdornment: (
